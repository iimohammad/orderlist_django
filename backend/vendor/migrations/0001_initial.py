    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brand', models.ManyToManyField(to='vendor.brand')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('part_image', models.ImageField(blank=True, null=True, upload_to='vendors/images')),
                ('part', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='vendor.part')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='part',
            name='vendor',
            field=models.ManyToManyField(to='vendor.vendor', verbose_name='Vendors'),
        ),
        migrations.AddField(
            model_name='collection',
            name='vendor',
            field=models.ManyToManyField(blank=True, to='vendor.vendor', verbose_name='Vendors'),
        ),
    ]
